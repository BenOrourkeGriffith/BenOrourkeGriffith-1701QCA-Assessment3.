...
The Interactive Ball maze is a game where the goal is to travel the ball back and forth between goals scoring points during a timelimit of 1 minute. The ball is moved by tilting the maze. When the ball hits the goals it creates a circuit and sends a message to the micro-bit letting it know to record a point and switch goals. Once the time limit is up a noise will be heard and the score will be displayed. This game is typically used at parties as a form of entertainment and can be played by everyone able to pick the box up. 
...
### images of and link to video ###

![Image](f8.jpg)

(https://youtu.be/OUNaGP_dDsk)
